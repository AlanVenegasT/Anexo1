...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección I. Datos generales</td>
        </tr>
        <tr style="width: 100%; ">
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección II. Metas</td>
        </tr>
        <tr style="width: 100%; ">
        ...
        <tr style="width: 100%; ">
            <td style="width: 16%;" class="seccion2columnrelleno" ></td>
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección III. Acciones programadas</td>
        </tr>
        <tr style="width: 100%; ">
...
<tbody id="tabla-body" style="width: 100%; font-size: 10px; background-color: #ffffff; border-color: #A6A6A6;  ">
